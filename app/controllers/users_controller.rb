class UsersController < ApplicationController
  ...
  def show
    ...
    @attending_events = @user.attending_events.upcoming_events.paginate(page: params[:page], per_page: 15)
    @expired_events = @user.attending_events.previous_events.paginate(page: params[:page], per_page: 15)
  end
